...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/sun6boys/CRGoodsDetailServiceProtocol"
  ...
  s.source       = { :git => "https://github.com/sun6boys/CRGoodsDetailServiceProtocol.git", :tag => s.version }
